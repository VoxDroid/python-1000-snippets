#!/usr/bin/env python3
"""PSO optimization of a shifted quadratic function."""
...
def pso_optimize(fitness, dim, num_particles=60, iterations=120):
    w = 0.6
    c1 = 1.2
    c2 = 1.2
...
def main():
    best_pos, best_score = pso_optimize(shifted_quadratic, dim=2)
