# sample1.py
# Demonstrates creating a keyspace and table, inserting rows, and querying them.
...
def _build_classpath(cassandra_home: str, cassandra_conf: str) -> str:
    ...
    # Include JSR223 jars if present
...
def main() -> None:
    ...
    try:
        ...
        for row in session.execute("SELECT id, name, age FROM users"):
            print(row)
